...
async function updatePhotoRecord(photoId, metadata, thumbnail) {
    ...
    // use graphql to pass in the whole mutation to aws 
    // as soon as the upload is done, amplify and lambda are commuincating 
...
// anytime lambda is triggered, this is what happpens
exports.handler = async event => {

    // first grabs bucket name,
